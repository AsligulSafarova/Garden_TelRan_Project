            ...
            <div className={s.header_menu} >
                <nav className={s.menu_body}>
                    ...
                    <div ref={nav_list_ref} className={s.menu_list} onClick={nav_btn_click}>
                        <NavLink className={checkClass} to='all_categories'>Категории</NavLink>
                        <NavLink className={checkClass} to='all_products'>Акции</NavLink>
                        <NavLink className={checkClass} to='contacts'>Контакты</NavLink>
