...
import {check_sort_promotions_action,price_search_promotions_action,word_search_promotions_action,reset_promotions_action} from '../../store/reducer/promotionsReducer';
	...
	return (
		<div className={s.filtr_container}>
			<div className={s.filt_block}>
				...
				<form className={s.sort}>
					...
					<select name='sorts' defaultValue='' id='sorts' onChange={check_sort_promotions}>
						...
						<option value='1'>Цена: high-low</option>
						<option value='2'>Цена: low-high</option>
					</select>
				</form>
			</div>
			...
			<div className={s.search_block}>
				...
				<button onClick={reset_promotions}>Сбросить настройки</button>
			</div>
		</div>
	);
}
