...
import { delete_basket_card_action, decrement_count_basket_action, increment_count_basket_action } from '../../../store/reducer/basketReducer';
        ...
        <div className={s.basket_item}>
            ...
            <div className={s.product_info}>
                ...
                <div className={s.product_count}>
                    <button onClick={() => dispatch(decrement_count_basket_action(id))}>-</button>
                    <p>{count}</p>
                    <button onClick={() => dispatch(increment_count_basket_action(id))}>+</button>
                </div>
            </div>
